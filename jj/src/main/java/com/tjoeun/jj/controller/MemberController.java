...
//	}
	...
	public void kakaoLogin(@RequestParam("code") String code, @RequestParam("apikey") String apikey,
			@RequestParam("redirectUri") String redirectUri, HttpServletRequest request, HttpServletResponse response)
...
//	ServletContext context;
	...
	public HashMap<String, Object> fileup(@RequestParam("image") MultipartFile file) throws AmazonServiceException, SdkClientException, IOException {
		HashMap<String, Object> result = new HashMap<String, Object>();
